...
namespace co_uring_http {
  ...
  auto buffer_ring::register_buffer_ring(const unsigned int buffer_ring_size, const size_t buffer_size) -> void {
  ...
  auto buffer_ring::borrow_buffer(const unsigned int buffer_id, const size_t size) -> std::span<std::byte> {
